    ...
    <>
      <div ref={(el) => (componentWrapper = el)} className="FoodBook">
        ...
        <div className="FoodBook__foodCategoriesBox">
          <div className="FoodBook__foodCategory FoodBook__foodCategory--tittle-breakfast">
            <img
              src={breakfastImage}
              alt="Breakfast"
          ...
          <div className="FoodBook__foodCategory FoodBook__foodCategory--tittle-supper">
            <img
              src={supperImage}
              alt="Supper"
          ...
          <div className="FoodBook__foodCategory FoodBook__foodCategory--tittle-snacks">
            <img
              src={snacksImage}
              alt="Snacks"
